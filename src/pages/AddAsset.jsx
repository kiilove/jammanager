...
const AddAsset = () => {
  ...
  const [addStep1Form, addStep2Form] = Form.useForm();
          ...
          >
            ...
            >
              <Select
                ...
                onChange={(value) => filterProductLine(value, memberSettings)}
              />
            </Form.Item>
              ...
              >
                <Form.Item noStyle>
                  <AutoComplete options={assetVendorOptions}>
                    <Input
                      style={{ width: media.isMobile ? "100%" : 250 }}
                      placeholder="제조사"
                    />
                  </AutoComplete>
                </Form.Item>
                ...
                <Form.Item noStyle>
                  <AutoComplete options={assetModelOptions}>
                    <Input
                      style={{ width: media.isMobile ? "100%" : 250 }}
                      placeholder="모델명"
                    />
            ...
            >
              <Input style={{ width: 100 }} addonAfter={<span>개월</span>} />
            </Form.Item>
